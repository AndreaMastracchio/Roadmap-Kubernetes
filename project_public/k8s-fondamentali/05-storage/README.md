...
## 📊 Ciclo di Vita dello Storage

```mermaid
graph TB
    ADMIN[Administrator] -->|1. Crea| PV[PersistentVolume]
    DEV[Developer] -->|2. Richiede| PVC[PersistentVolumeClaim]
    PVC -->|3. Binding| PV
    POD[Pod] -->|4. Monta| PVC
    
    SC[StorageClass] -.->|Provisioning<br/>Dinamico| PV
    DEV -.->|Specifica| SC
    
    style ADMIN fill:#FFD700
    style DEV fill:#90EE90
    style PV fill:#87CEEB
    style PVC fill:#DDA0DD
