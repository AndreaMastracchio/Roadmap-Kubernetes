...
```mermaid
graph LR
    USER[User/ServiceAccount] -->|ha| RB[RoleBinding]
    RB -->|assegna| ROLE[Role]
    ROLE -->|permette| RES[Resources<br/>pods, services, etc]
    
    USER2[User/ServiceAccount] -->|ha| CRB[ClusterRoleBinding]
    CRB -->|assegna| CROLE[ClusterRole]
    CROLE -->|permette| CRES[Cluster Resources<br/>nodes, PV, etc]
    
    style USER fill:#90EE90
    style USER2 fill:#90EE90
    style RB fill:#FFD700
    style CRB fill:#FFD700
    style ROLE fill:#87CEEB
    style CROLE fill:#FF6B6B
```
